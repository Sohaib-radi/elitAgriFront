...
const BASE_COMPONENTS = TYPOGRAPHY_VARIANTS.map((variant) => ({
  ...
  component: <BlockVariant typographyVariant={variant} />,
}));
...
function BlockVariant({ typographyVariant }: BlockVariantProps) {
  ...
  return (
    <ComponentBox sx={componentBoxStyles}>
      <Typography ref={typographyRef} variant={typographyVariant}>
